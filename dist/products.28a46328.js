...
exports.segmentToDistributedPoints = segmentToDistributedPoints;
  ...
  if (totalPoints > l) {
    ...
    for (ci = 0; ci < l; ci++) {
      ...
      for (j = 1; j <= curvePoints; j++) {
        ...
        i = ~~(i / resolution) * 6;
        a = segment[i];
        points.push(_round((t * t * (segment[i + 6] - a) + 3 * inv * (t * (segment[i + 4] - a) + inv * (segment[i + 2] - a))) * t + a),
        // x
...
var CustomEase = exports.default = exports.CustomEase = /*#__PURE__*/function () {
  ...
  CustomEase.getSVGData = function getSVGData(ease, config) {
    ...
    if (ease instanceof CustomEase) {
      a = (0, _paths.rawPathToString)((0, _paths.transformRawPath)([ease.segment.slice(0)], width, 0, 0, -height, x, y));
    } else {
      a = [x, y];
...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"src/products.js":[function(require,module,exports) {
"use strict";
...
_gsap.default.registerPlugin(_ScrollTrigger.ScrollTrigger, _CustomEase.CustomEase, _SplitText.SplitText);
document.querySelectorAll('.ticker').forEach(function (ticker) {
  var inner = ticker.querySelector('.ticker-wrap');
  var content = inner.querySelector('.ticker-text');
  var duration = ticker.getAttribute('data-duration');
  inner.append(content.cloneNode(true));
  var animations = [];
  inner.querySelectorAll('.ticker-text').forEach(function (element) {
    var animation = _gsap.default.to(element, {
      x: "-100%",
      repeat: -1,
      duration: duration,
      ease: 'linear'
...
var showAnim = _gsap.default.from('.nav-container', {
  yPercent: -100,
  paused: true,
  duration: 0.2
}).progress(1);
...
textContainers.forEach(function (container) {
  ...
  textElements.forEach(function (element) {
    var split = _SplitText.SplitText.create(element, {
      type: "lines",
      mask: "lines",
      linesClass: "line"
    });
    containerSplits.push(split);
    _gsap.default.set(split.lines, {
      y: "110%"
    });
  });
...
var copyContainers = document.querySelectorAll('.menu-cols');
...
var toggleMenu = function toggleMenu() {
  ...
  if (!isMenuOpen) {
    ...
    splitTextByContainer.forEach(function (containerSplits) {
      var copyLines = containerSplits.flatMap(function (split) {
        return split.lines;
      });
      t1.to(copyLines, {
        y: "0%",
    ...
    var _t = _gsap.default.timeline();
    _t.to(outerContainer, {
      y: "0svh",
      duration: 1,
      ease: "hop",
      clearProps: "all"
    ...
    _t.call(function () {
      splitTextByContainer.forEach(function (containerSplits) {
        ...
        _gsap.default.set(copyLines, {
          y: "-110%"
        });
      });
      _gsap.default.set(copyContainers, {
        opacity: 1
      });
      _gsap.default.set(menuMediaWrapper, {
        opacity: 0
      });
      isAnimating = false;
      if (lenis) {
...
},{"@splidejs/splide":"node_modules/@splidejs/splide/dist/js/splide.esm.js","gsap":"node_modules/gsap/index.js","gsap/CustomEase":"node_modules/gsap/CustomEase.js","gsap/SplitText":"node_modules/gsap/SplitText.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/products.js"], null)
//# sourceMappingURL=/products.28a46328.js.map